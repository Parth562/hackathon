...
class AgentState(TypedDict):
    ...
    # Auto-retrieved RAG context from uploaded documents (populated by intent_node)
    ...
    required_agents: Optional[List[str]]      # Which agents to actually run (e.g. ["research","data","analysis"])
